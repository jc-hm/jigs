...
export const config = {
  ...
  bedrockModelSonnet: process.env.BEDROCK_MODEL_SONNET || "anthropic.claude-sonnet-4-6",
  bedrockModelHaiku: process.env.BEDROCK_MODEL_HAIKU || "anthropic.claude-haiku-4-5-20251001-v1:0",
  superAdminCognitoId: process.env.SUPER_ADMIN_COGNITO_ID || "",
  usageBucket: process.env.USAGE_BUCKET || "",
};
